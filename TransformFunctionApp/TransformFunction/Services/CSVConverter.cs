...
namespace TransformFunction.Services
{
    ...
    {
        public async Task<string> GetJsonAsync(Stream stream, string targetJsonFormat)
        {
        ...
        private async Task<List<dynamic>> GetDynamicListAsync(Stream stream, string targetJsonFormat)
        {
        ...
        private Dictionary<string, object> GetMappings(Dictionary<string, object> datap)
        {
        ...
        public string GetJson(Stream stream, string targetJsonFormat)
        {
        ...
        private List<dynamic> GetDynamicList(Stream stream, string targetJsonFormat)
        {
            if (stream is null || string.IsNullOrEmpty(targetJsonFormat))
            {
                return null;
        ...
        private Dictionary<string, object> GetTemplateMappings(string jsonTemplate)
        {
        ...
        public async Task<List<string>> GetJsonListAsync(Stream stream, string targetJsonFormat)
        {
            var records = await GetDynamicListAsync(stream, targetJsonFormat);
            return GetDynamicJsonObjects(records);
        }

        public List<string> GetJsonList(Stream stream, string targetJsonFormat)
        {
            var records = GetDynamicList(stream, targetJsonFormat);
            return GetDynamicJsonObjects(records);
        }
